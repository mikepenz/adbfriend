...
class Test : AdbCommand() {
    ...
    private val stayOn: Boolean? by option().flag("--no-stay-on").help("Keeps device awake while USB connected (`svc power stayon usb`). Use --stay-on to enable, --no-stay-on to disable.")
